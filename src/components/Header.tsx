...
const Header = () => {
  ...
  return (
    <header className="relative min-h-screen bg-gradient-to-b from-black to-gray-900 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 to-black"></div>
      <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_20%,rgba(59,130,246,0.1),transparent_50%)] overflow-hidden"></div>
      <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_70%_80%,rgba(16,185,129,0.1),transparent_50%)] overflow-hidden"></div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-full overflow-hidden">
        ...
        <div className="text-center max-w-6xl mx-auto px-2">
          ...
          <div className="mb-12 max-w-4xl mx-auto">
            <div className="relative bg-white rounded-2xl p-3 md:p-6 border border-gray-200 shadow-lg mx-2">
